...
async def render_video(
    ...
    # Add probesize and analyzeduration for better stream detection
    command = f"ffmpeg -probesize 5000000 -analyzeduration 10000000 {video_inputs} -shortest -c:v libx264 -c:a aac -preset veryfast {output_path}"
